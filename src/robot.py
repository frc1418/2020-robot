...
class Robot(magicbot.MagicRobot):
    ...
    def createObjects(self):
        ...
        self.one = Toggle(self.joystick_alt, 7)
        self.two = Toggle(self.joystick_alt, 8)
        self.three = Toggle(self.joystick_alt, 9)
        self.four = Toggle(self.joystick_alt, 10)
        self.five = Toggle(self.joystick_alt, 11)
        self.six = Toggle(self.joystick_alt, 12)
